...
namespace IPCOREUS
{
	...
	public class US_V_GD_DAT_HANG : US_Object
	{
		...
		public decimal dcID_TRANG_THAI_DON_HANG 
		{
			get
			{
				return CNull.RowNVLDecimal(pm_objDR, "ID_TRANG_THAI_DON_HANG", IPConstants.c_DefaultDecimal);
			}
			set	
			{
				pm_objDR["ID_TRANG_THAI_DON_HANG"] = value;
			}
		}

		public bool IsID_TRANG_THAI_DON_HANGNull()	{
			return pm_objDR.IsNull("ID_TRANG_THAI_DON_HANG");
		}

		public void SetID_TRANG_THAI_DON_HANGNull() {
			pm_objDR["ID_TRANG_THAI_DON_HANG"] = System.Convert.DBNull;
		}
